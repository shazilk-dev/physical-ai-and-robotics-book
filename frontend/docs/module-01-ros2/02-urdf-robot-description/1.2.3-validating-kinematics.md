...
**Scenario:** You build a humanoid arm in URDF. It looks great in RViz! You deploy to the real robot and... 💥 **the elbow bends backwards and breaks**.
...
graph LR
    ...
    C --> D[💥 Hardware Damage<br/>$10,000 repair]
...
```mermaid
graph LR
    A[Joint Angles<br/>θ₁=30°, θ₂=45°, θ₃=-20°] -->|Forward Kinematics| B[End Effector Position<br/>x=0.5m, y=0.2m, z=0.3m]
...
```mermaid
graph LR
    A[Desired Position<br/>x=0.5m, y=0.2m, z=0.3m] -->|Inverse Kinematics| B[Joint Angles<br/>θ₁=?, θ₂=?, θ₃=?]
...
<joint name="shoulder_joint" type="revolute">
  <limit lower="-3.14" upper="3.14"/>  ❌ Too much range!
</joint>
```
...
```mermaid
graph LR
    A[Joint Config<br/>θ₁=0°, θ₂=180°] -->|Check| B{Collision?}
    B -->|Yes| C[❌ Invalid Pose<br/>Forearm in torso]
    B -->|No| D[✅ Valid Pose]
...
```mermaid
graph TB
    A[Robot Base] --> B[Reachable Zone<br/>Sphere of radius L₁+L₂+L₃]
...
- ✅ No URDF syntax errors
- ✅ Arm moves smoothly through full range
- ✅ No self-collisions at extreme poses
- ✅ Stable in Gazebo (no jitter/explosions)
...
- ✅ Validate joint limits against real hardware
- ✅ Check for self-collisions
- ✅ Calculate mass and inertia correctly
- ✅ Visualize robot workspace
- ✅ Test dynamics in Gazebo simulation
- ✅ Use `check_urdf` tool for validation
