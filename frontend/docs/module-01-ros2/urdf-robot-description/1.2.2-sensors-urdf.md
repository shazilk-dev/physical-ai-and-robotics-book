---
id: sensors-urdf
title: "1.2.2 Sensors in URDF & Plugin Wiring"
sidebar_label: "1.2.2 Sensors in URDF"
---
...
- ✅ Test perception algorithms in simulation before buying hardware
- ✅ Simulate sensor noise and failures
- ✅ Visualize sensor data in RViz (camera frustums, LiDAR scans)
- ✅ Same URDF works in Gazebo, Isaac Sim, and real hardware
...
graph LR
    ...
    B --> E[📷 Camera Frame<br/>X: Right<br/>Y: Down<br/>Z: Forward]
    C --> F[🧭 IMU Frame<br/>Measures rotation]
    D --> G[📡 LiDAR Frame<br/>Scans environment]
```
...
- Generates 640×480 RGB images at 30 FPS
...
```
/robot/camera/image_raw       ✅ Clear hierarchy
/robot/camera/depth/image_raw ✅ Organized
/img                          ❌ Unclear
```
...
- ✅ Add camera, IMU, and LiDAR sensors to URDF
- ✅ Create optical frames with correct rotations
- ✅ Configure Gazebo plugins for sensor simulation
- ✅ Set realistic update rates and noise models
- ✅ Visualize sensor data in RViz
- ✅ Follow sensor naming conventions
