---
id: package-testing
title: "1.2.4 Package Testing & CI Basics"
sidebar_label: "1.2.4 Package Testing"
---
...
graph LR
    ...
    B --> C[Teammate Pulls]
    C --> D[💥 Robot Broken<br/>Lost 4 hours]

    A -->|Automated Tests| E{Tests Pass?}
    E -->|No| F[Fix Issues]
    F --> E
    E -->|Yes| G[✅ Safe to Push]
...
✅ Are joint limits specified?

### 2. Kinematic Tests

✅ Do transforms connect properly?  
✅ Is the kinematic tree valid?  
✅ Are there disconnected links?

### 3. Collision Tests

✅ Does the robot self-collide in default pose?  
✅ Are collision meshes defined for all links?

### 4. Sensor Tests

✅ Are all sensor frames defined?  
✅ Do optical frames exist for cameras?  
✅ Are sensor plugins correctly configured?

### 5. Integration Tests

✅ Can the robot spawn in Gazebo?  
✅ Do RViz visualizations work?  
✅ Can MoveIt load the robot?
...
- ✅ Write pytest tests for URDF validation
- ✅ Test syntax, kinematics, collisions, sensors
- ✅ Set up GitHub Actions CI pipeline
- ✅ Use pre-commit hooks for local validation
- ✅ Measure code coverage
- ✅ Debug failed tests effectively
- ✅ Follow test pyramid best practices
